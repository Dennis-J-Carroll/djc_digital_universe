...
const EXPECTED_DEPLOYMENT_SEGMENTS = ['static', 'apps', 'algebraic-flow']
...
export function assertSafeAlgebraicFlowDeploymentTarget(repoRoot, deploymentTarget) {
  ...
  if (normalizedTarget !== expectedTarget) {
    throw new Error('Refusing to deploy outside static/apps/algebraic-flow')
  }
