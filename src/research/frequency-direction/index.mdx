...
*The Frequency Prior Series is complete. Start at [Frequency Wins](/research/frequency-wins/), or read [Steering the Prior](/research/steering-the-prior/). All results from real-model inference via TransformerLens — not simulation.*
