...
seriesNext: "/research/resolution-ladder/"
status: "live"
...
*Paper 4 of the Frequency Prior Series (an extension). Model: GPT-2 Small (124M, 12 layers, 12 heads, 768-d residual stream). Platform: TransformerLens — all results from real-model inference.*
...
*The Frequency Prior Series: start at [Frequency Wins](/research/frequency-wins/), then [Steering the Prior](/research/steering-the-prior/) and [Frequency in All Directions](/research/frequency-direction/). All results from real-model inference via TransformerLens — not simulation.*
